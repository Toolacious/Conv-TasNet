...
parser.add_argument('--model_path', type=str, default='final.pth.tar',
                    help='Path to model file created by training')
parser.add_argument('--mix_json', type=str, default='data/tt/mix.json',
                    help='Json file including mixture wav files')
parser.add_argument('--out_dir', type=str, default='separate/',
...
def separate(args):
    if args.mix_json is None:
        print("Must provide mix_json!")
